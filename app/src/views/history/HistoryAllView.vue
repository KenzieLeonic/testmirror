    ...
    <div class="mx-auto font-mono text-gray-700 max-w-7xl">
      ...
      <div class="flex items-center pb-0">
        ...
        <div class="relative">
          ...
          <input id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                 placeholder="Search for items"
                 type="text">
        </div>
        <button class="p-2.5 ml-2 text-sm font-medium text-white rounded-lg bg-angelBaby-300  border border-angelBaby-300 hover:bg-blue-800 focus:ring-3 focus:outline-none focus:ring-angelBaby-200"
                type="submit">
      ...
      <div class="flex">
        ...
        <div class="flex items-center mr-4">
          <input id="inline-checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="checkbox"
                 value="">
          <label class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="inline-checkbox">Inbound</label>
        </div>
        <div class="flex items-center mr-4">
          <input id="inline-2-checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="checkbox"
                 value="">
      ...
      <div class="overflow-x-auto relative shadow-md sm:rounded-lg mt-2">
        <table class="w-full text-sm text-left text-gray-800 dark:text-gray-400">
          ...
          <tr class="border-t">
            <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">{{ product.itemID }}</th>
            <td class="py-3 px-6 bg-white">{{ product.name }}</td>
            <td class="py-3 px-6 bg-gray-50 dark:bg-gray-800">{{}}</td>
