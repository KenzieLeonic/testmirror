  ...
  <div class="min-h-screen bg-angelBaby-100">
    <div class="font-mono mx-auto max-w-7xl text-gray-700">
      ...
      <div class="flex items-center pb-4">
        ...
        <button type="submit" @click="searchProduct" class="p-2.5 ml-2 text-sm font-medium text-white rounded-lg bg-angelBaby-300  border border-angelBaby-300 hover:bg-blue-800 focus:ring-3 focus:outline-none focus:ring-angelBaby-200">
